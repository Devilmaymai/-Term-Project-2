...
Data來自Aldea人工智慧共創平台的"尋找病媒蚊孳生源-積水容器影像物件辨識"競賽。(https://aidea-web.tw/topic/47b8aaa7-f0fc-4fee-af28-e0f077b856ae) 目的是藉由機器學習，偵測照片中的積水容器。並且期盼能透過影像物件偵測技術，讓稽查人員藉由影像或是視訊提醒其積水容器之物件位置，提高稽查效率外。並且期望能更進一步運用於其他載具中，協助登革熱的防治。
